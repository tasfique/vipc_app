...
import 'package:vipc_app/view/notifications/manager_notification_view.dart';
...
import 'package:vipc_app/view/search/manager_serach_view.dart';
...
class _ManagerViewState extends StateMVC {
  _ManagerViewState() : super(ManagerController()) {
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(
                                      'Hello, ' + _con.managerDetail.fullName,
                                      style: TextStyle(
                                        fontSize: 18,
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ManagerNotificationView()));
                    },
                  ),
                  Container()
                ])
      ...
      child: ListView(
        ...
        children: <Widget>[
          UserAccountsDrawerHeader(
            accountName: Text(_con.managerDetail.fullName),
            decoration: BoxDecoration(
              color: Colors.amber,
            ),
            accountEmail: Text(
              _con.managerDetail.email,
              style: TextStyle(
                fontSize: 18,
